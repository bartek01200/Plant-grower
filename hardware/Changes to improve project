...
Secure exposed pump and relay wiring using proper terminal blocks, strain-relief boots, and heat-shrink tubing to prevent loose leads and eliminate short-circuit risks.


## IP rated protective enclosure
House the ESP32, relay, and breadboard inside a custom splash-proof (IP65) enclosure to protect sensitive electronics from water spills and high-humidity environments in a commercial setup.
